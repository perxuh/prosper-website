            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16 max-w-4xl mx-auto w-full text-left">
              {[
                ...
                <div 
                  ...
                  className="parallax-card cursor-pointer p-8 rounded-[2rem] border border-white/5 bg-[#14151B]/50 backdrop-blur-xl hover:bg-surface hover:border-white/10 transition-colors shadow-2xl relative overflow-hidden group flex flex-col items-start"
                  style={{
