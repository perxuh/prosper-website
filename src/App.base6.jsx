      ...
      >
        <div className="hero-content max-w-4xl space-y-6 flex flex-col items-center text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                <LiquidButton colorMode="purple" onClick={onOpenWaitlist}>
                  Get Early Access <ArrowRight size={20} />
                </LiquidButton>
                <LiquidButton colorMode="dark">
                  Speak with an advisor <MessageSquare size={20} />
                </LiquidButton>
            </div>
...
function Testimonials() {
    ...
    let ctx = gsap.context(() => {
      gsap.from(containerRef.current, {
        ...
        scrollTrigger: {
          ...
          start: "top 80%", // Aggressively triggers when just the top crests the screen
  ...
  const testimonials = [
    {
      quote: "Prosper completely rewired how I view my wealth. The AI education is impossibly clear, and the advisors act like true fiduciaries. It feels like having a private family office in my pocket.",
    ...
    {
      quote: "The interface is absolutely cinematic. I used to dread checking my portfolio, but the seamless data visualization and real-time latency makes wealth building an addictive experience.",
    ...
    {
      quote: "Finding an advisor who actually understood tech equity and startup liquidity used to be impossible. Prosper connects you to experts who speak the language of modern finance.",
  ...
  return (
    <section id="testimonials" ref={containerRef} className="relative w-full flex flex-col items-center justify-center -mt-24 md:-mt-48 pb-32 pt-12 px-6 lg:px-24 bg-transparent z-10 overflow-hidden transform-gpu">
...
export default function App() {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      const colors = ["#14151B", "#1A1B23", "#0E1015", "#1E1F29", "#14151B", "#181A22", "#14151B", "#0D0E12"];
      const sections = ['#app-walkthrough', '#testimonials', '#about-section', '#pricing', '#faq'];
  ...
  return (
    <div ref={mainRef} className="min-h-screen relative selection:bg-pink selection:text-white" style={{ backgroundColor: '#14151B' }}>
      ...
      <Testimonials />
      <AboutUsSection />
      <PricingTiers onOpenWaitlist={() => setWaitlistOpen(true)} />
      <FAQSection />
      <Footer />
